    ...
    <div class="gallery" id="gallery">
        ...
        <a href="?page=product">
            <div class="product-card-gallery fade-in" data-category="smartphones">
                ...
                <div class="product-price-gallery">$1,299 <span
                        style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
            </div>
        </a>
        ...
        <div class="product-card-gallery fade-in" data-category="smartphones">
            ...
            <div class="product-price-gallery">$1,599 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
        ...
        <div class="product-card-gallery fade-in" data-category="laptops">
            ...
            <div class="product-price-gallery">$2,899 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
        ...
        <div class="product-card-gallery fade-in" data-category="laptops">
            ...
            <div class="product-price-gallery">$1,899 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
        ...
        <div class="product-card-gallery fade-in" data-category="tablets">
            ...
            <div class="product-price-gallery">$1,199 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
        ...
        <div class="product-card-gallery fade-in" data-category="tablets">
            ...
            <div class="product-price-gallery">$1,399 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
        ...
        <div class="product-card-gallery fade-in" data-category="gaming">
            ...
            <div class="product-price-gallery">$649 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
        ...
        <div class="product-card-gallery fade-in" data-category="gaming">
            ...
            <div class="product-price-gallery">$799 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
        ...
        <div class="product-card-gallery fade-in" data-category="accesorios">
            ...
            <div class="product-price-gallery">$249 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
        ...
        <div class="product-card-gallery fade-in" data-category="accesorios">
            ...
            <div class="product-price-gallery">$39 <span
                    style="font-size: 0.8rem; color: var(--c-gris-medio-main);">USD</span></div>
        </div>
    </div>
</div>
